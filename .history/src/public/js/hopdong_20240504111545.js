$(document).ready(function () {
  ...
  $("#themHopdong").submit(function (e) {
    ...
    // Diễn dịch dữ liệu từ form.
    var hopDongData = $(this).serialize();
    console.log(hopDongData);

    // Nếu dữ liệu nhập vào form đã đầy đủ, hãy chạy code ở đây.
    // Bạn có thể thêm phần code gửi dữ liệu đến máy chủ ở đây.
  });
});
